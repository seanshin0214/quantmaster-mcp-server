...
import { erf, calculatePower, normalCDF } from "../utils/math.js";
...
async function handleGetMethodGuide(args: Record<string, unknown>) {
  const method = args.method as string;
  const aspect = (args.aspect as string) || "all";

  const methodGuides: Record<string, any> = {
    ols: {
